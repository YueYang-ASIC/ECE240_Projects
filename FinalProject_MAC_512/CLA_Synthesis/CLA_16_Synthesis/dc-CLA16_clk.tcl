...
#   report_power -hier
#   set_max_delay
#   write -format db -output CLA16_clk.db
#
# Doesn't work quite the way I expect
#   NameDesign = CLA16_clk    Set variable ok, but how to concatenate?
#   write_rtl -format verilog -output CLA16_clk.vg


#===== Set: make sure you change design name elsewhere in this file
set NameDesign "CLA16_clk"
...
analyze -format verilog CLA16_clk.v
...
#===== Reports
write -format verilog -output CLA16_clk.vg -hierarchy $NameDesign
write_sdc	CLA16_clk.sdc
report_area               > CLA16_clk.area
report_power              > CLA16_clk.pow
report_timing -nworst 10  > CLA16_clk.tim
