...
# Created by write_sdc on Mon Apr 28 19:29:20 2025
...
set_max_area 0
set_load -pin_load 1.5 [get_ports res]
...
set_input_delay -clock clk  0.0051  [get_ports A_in]
set_input_delay -clock clk  0.0051  [get_ports B_in]
set_output_delay -clock clk  0.0068  [get_ports res]
