...
#   report_power -hier
#   set_max_delay
#   write -format db -output CLA64_clk.db
#
# Doesn't work quite the way I expect
#   NameDesign = CLA64_clk    Set variable ok, but how to concatenate?
#   write_rtl -format verilog -output CLA64_clk.vg


#===== Set: make sure you change design name elsewhere in this file
set NameDesign "CLA64_clk"
...
analyze -format verilog ./CLA64_clk.v
...
#===== Reports
write -format verilog -output CLA64_clk.vg -hierarchy $NameDesign
write_sdc	CLA64_clk.sdc
report_area               > CLA64_clk.area
report_power              > CLA64_clk.pow
report_timing -nworst 10  > CLA64_clk.tim
