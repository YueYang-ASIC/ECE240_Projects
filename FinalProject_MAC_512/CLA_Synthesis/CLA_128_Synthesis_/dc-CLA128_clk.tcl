...
#   report_power -hier
#   set_max_delay
#   write -format db -output CLA128_clk.db
#
# Doesn't work quite the way I expect
#   NameDesign = CLA128_clk    Set variable ok, but how to concatenate?
#   write_rtl -format verilog -output CLA128_clk.vg


#===== Set: make sure you change design name elsewhere in this file
set NameDesign "CLA128_clk"
...
analyze -format verilog CLA128_clk.v
analyze -format verilog CLA128.v
...
#===== Reports
write -format verilog -output CLA128_clk.vg -hierarchy $NameDesign
write_sdc	CLA128_clk.sdc
report_area               > CLA128_clk.area
report_power              > CLA128_clk.pow
report_timing -nworst 10  > CLA128_clk.tim
