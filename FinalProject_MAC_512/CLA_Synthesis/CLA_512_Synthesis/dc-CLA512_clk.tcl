...
#   report_power -hier
#   set_max_delay
#   write -format db -output CLA512_clk.db
#
# Doesn't work quite the way I expect
#   NameDesign = CLA512_clk    Set variable ok, but how to concatenate?
#   write_rtl -format verilog -output CLA512_clk.vg


#===== Set: make sure you change design name elsewhere in this file
set NameDesign "CLA512_clk"
...
analyze -format verilog CLA512_clk.v
...
#===== Reports
write -format verilog -output CLA512_clk.vg -hierarchy $NameDesign
write_sdc	CLA512_clk.sdc
write_sdf	CLA512_clk.sdf


report_area               > CLA512_clk.area
report_cell               > CLA512_clk.cell
report_hierarchy          > CLA512_clk.hier
report_net                > CLA512_clk.net
report_power              > CLA512_clk.pow
report_timing -nworst 10  > CLA512_clk.tim
