...
#   report_power -hier
#   set_max_delay
#   write -format db -output MAC_512_CLA.db
#
# Doesn't work quite the way I expect
#   NameDesign = MAC_512_CLA    Set variable ok, but how to concatenate?
#   write_rtl -format verilog -output MAC_512_CLA.vg


#===== Set: make sure you change design name elsewhere in this file
set NameDesign "MAC_512_CLA"
...
analyze -format verilog MAC_512_CLA.v
...
#===== Reports
write -format verilog -output MAC_512_CLA.vg -hierarchy $NameDesign
write_sdc	MAC_512_CLA.sdc
write_sdf	MAC_512_CLA.sdf


report_area               > MAC_512_CLA.area
report_cell               > MAC_512_CLA.cell
report_hierarchy          > MAC_512_CLA.hier
report_net                > MAC_512_CLA.net
report_power              > MAC_512_CLA.pow
report_timing -nworst 10  > MAC_512_CLA.tim
