...
#   report_power -hier
#   set_max_delay
#   write -format db -output MAC512_SA_RCA.db
#
# Doesn't work quite the way I expect
#   NameDesign = MAC512_SA_RCA    Set variable ok, but how to concatenate?
#   write_rtl -format verilog -output MAC512_SA_RCA.vg


#===== Set: make sure you change design name elsewhere in this file
set NameDesign "MAC512_SA_RCA"
...
analyze -format verilog MAC512_SA_RCA.v
analyze -format verilog CLA64.v
analyze -format verilog CLA_generator4.v
analyze -format verilog RCA.v
analyze -format verilog CLA16.v
analyze -format verilog ShiftAddMult.v
...
#===== Reports
write -format verilog -output MAC512_SA_RCA.vg -hierarchy $NameDesign
write_sdc	MAC512_SA_RCA.sdc
write_sdf	MAC512_SA_RCA.sdf


report_area               > MAC512_SA_RCA.area
report_cell               > MAC512_SA_RCA.cell
report_hierarchy          > MAC512_SA_RCA.hier
report_net                > MAC512_SA_RCA.net
report_power              > MAC512_SA_RCA.pow
report_timing -nworst 10  > MAC512_SA_RCA.tim
