...
#   report_power -hier
#   set_max_delay
#   write -format db -output abc.db
#
# Doesn't work quite the way I expect
#   NameDesign = abc    Set variable ok, but how to concatenate?
#   write_rtl -format verilog -output abc.vg
...
#===== Reports
write -format verilog -output abc.vg -hierarchy $NameDesign
write_sdc	abc.sdc
write_sdf	abc.sdf


report_area               > abc.area
report_cell               > abc.cell
report_hierarchy          > abc.hier
report_net                > abc.net
report_power              > abc.pow
report_timing -nworst 10  > abc.tim
