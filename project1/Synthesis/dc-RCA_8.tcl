...
#   report_power -hier
#   set_max_delay
#   write -format db -output RCA_8.db
#
# Doesn't work quite the way I expect
#   NameDesign = RCA_8    Set variable ok, but how to concatenate?
#   write_rtl -format verilog -output RCA_8.vg


#===== Set: make sure you change design name elsewhere in this file
set NameDesign "RCA_8"
...
#===== Reports
write -format verilog -output RCA_8.vg -hierarchy $NameDesign
write_sdc	RCA_8.sdc
write_sdf	RCA_8.sdf


report_area               > RCA_8.area
report_cell               > RCA_8.cell
report_hierarchy          > RCA_8.hier
report_net                > RCA_8.net
report_power              > RCA_8.pow
report_timing -nworst 10  > RCA_8.tim
