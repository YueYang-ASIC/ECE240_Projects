...
#===== Reports
write -format verilog -output FPU_Main.vg -hierarchy $NameDesign
write_sdc	FPU_Main.sdc
write_sdf	FPU_Main.sdf


report_area               > FPU_Main.area
report_cell               > FPU_Main.cell
report_hierarchy          > FPU_Main.hier
report_net                > FPU_Main.net
report_power              > FPU_Main.pow
report_timing -nworst 10  > FPU_Main.tim
